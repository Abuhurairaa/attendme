...
import 'package:attendme/teacher_ui/teacher_create_qr.dart';
import 'package:attendme/teacher_ui/teacher_edit_email.dart';
import 'package:attendme/teacher_ui/teacher_edit_password.dart';
import 'package:attendme/teacher_ui/teacher_edit_profile.dart';
import 'package:attendme/teacher_ui/teacher_list_attendance.dart';

import 'package:attendme/teacher_ui/teacher_selected_class.dart';
                      ...
                      builder: (_, snapshot) {
                        if (snapshot.data != null) {
                          if (snapshot.data!.docs.isEmpty) {
                            return const Text('Attendance data not found!');
                          } else {
                            return SingleChildScrollView(
                              child: Column(
                                children: snapshot.data!.docs
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: const Text(
                          "Let's go make a class attendance",
            ...
            children: [
              ...
              GestureDetector(
                onTap: () async {
                  ...
                  await FirebaseFirestore.instance
                      .collection('presence')
                      .where('attendance_id', isEqualTo: attendanceData.id)
                      .get()
                      .then((value) async {
                            ...
                            subtitle: Row(
                              children: [
                                TextButton(
                                  ...
                                  child: Text(
                                    'View ${e.data()['student_name']} Location',
                                    style: TextStyle(color: colorBlue),
                                  ),
                                ),
                                Icon(
